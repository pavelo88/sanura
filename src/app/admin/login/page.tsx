      ...
      <form onSubmit={handleLogin} className="w-full max-w-md">
        <div className="bg-[#121A21] border border-[#1F2E3A] p-10 md:p-14 shadow-2xl text-center rounded-3xl space-y-8 relative overflow-hidden group">
          ...
          <div className="space-y-2">
            <p className="font-serif text-3xl md:text-4xl text-white uppercase tracking-tight font-light">Protocolo Admin</p>
            <p className="text-[#5BC0BE] text-[10px] tracking-[0.4em] uppercase font-bold opacity-70">SANURA SECURITY v4.2</p>
          </div>
